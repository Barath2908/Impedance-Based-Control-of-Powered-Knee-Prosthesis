...
addpath('C:\Users\ibra5\Desktop\EMG data 1.5\Microprocessor-Controlled-Prosthetic-Knee-main\Fits')  
%% CALCULATIONS
Ti = 0;             % s
...
% Right Leg
cd("C:\Users\ibra5\Desktop\EMG data 1.5\Microprocessor-Controlled-Prosthetic-Knee-main\Position Functions");
rib_xr = rib_x(tr);
rib_yr = rib_y(tr);
hip_xr = hip_x(tr);
hip_yr = hip_y(tr);
